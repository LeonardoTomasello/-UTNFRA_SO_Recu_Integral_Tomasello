...
#Modificar tasks de Alta_Usuarios_Tomasello
vim roles/Alta_Usuarios_Tomasello/tasks/main.yml

- name: "Rol: Alta_Usuarios_Tomasello"
  debug:
    msg: "Inicio de tareas dentro del Rol: Alta_Usuarios_Tomasello"
...
#Modificar tasks de Sudoers_Tomasello
...
#Modificar tasks de Instala-tools_Tomasello
